...
// Generate PDF with html2pdf as primary method, using FileSaver.js
window.generatePDF = async function() {
  try {
    ...
    title.textContent = 'جدول NileVibe الأسبوعي';
    ...
    const headerRow = document.createElement('tr');
    ['اليوم', 'الصباح', 'الظهر', 'المساء'].forEach(text => {
    ...
    footer.textContent = 'Powered by NileVibe - اكتشف القاهرة بفخامة';
